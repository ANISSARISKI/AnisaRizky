...
(function(){
	...
	for(var i=0,j=a.length;i<j;i++){
		...
		if (testResult != -1){
			...
			a[i].setAttribute('href',"http://" + serverAddress + "/transmission/web/addtorrent.html?torrentlink=" + encodeURIComponent(linkurl) + "&cs=" + encodeURIComponent(cookieString) + "&version=" + versionNum );
